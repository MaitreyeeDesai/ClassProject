...
public class UserServicesServiceLocator extends org.apache.axis.client.Service implements serviceProviders.UserServicesService {
    ...
    private java.lang.String UserServices_address = "http://localhost:8080/EmailCampaign/services/UserServices";
    ...
    public serviceProviders.UserServices getUserServices() throws javax.xml.rpc.ServiceException {
    ...
    public serviceProviders.UserServices getUserServices(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            serviceProviders.UserServicesSoapBindingStub _stub = new serviceProviders.UserServicesSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (serviceProviders.UserServices.class.isAssignableFrom(serviceEndpointInterface)) {
                serviceProviders.UserServicesSoapBindingStub _stub = new serviceProviders.UserServicesSoapBindingStub(new java.net.URL(UserServices_address), this);
                _stub.setPortName(getUserServicesWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://serviceProviders", "UserServicesService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://serviceProviders", "UserServices"));
        }
